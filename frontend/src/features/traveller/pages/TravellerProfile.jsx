...
import { fetchTravellerProfile, updateTravellerProfile } from "../travellerAPI";
...
export default function TravellerProfile() {
  ...
  useEffect(() => {
    const load = async () => {
      setLoading(true);
      try {
        const res = await fetchTravellerProfile();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      updateUser({
        ...
        name: updatedData.name || `${updatedData.firstName} ${updatedData.lastName}`,
